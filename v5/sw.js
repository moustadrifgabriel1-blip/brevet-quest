...
const V='bq5-v20';const FILES=['./','./index.html','./data.enc','./acces.js','./entrainement.js','./fsrs.js','./migrer.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./three.module.min.js'];
